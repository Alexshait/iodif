...
<body>
    ...
    <div class="main_page tabs">
        <div class="tab">
            <input type="radio" id="tab-1" name="tab-group-1" <?php
        ...
        <div class="tab">
            <input type="radio" id="tab-2" name="tab-group-1" <?php
        ...
        <div class="tab">
            <input type="radio" id="tab-3" name="tab-group-1" <?php
        ...
        <div class="tab">
            <input type="radio" id="tab-4" name="tab-group-1" <?php
        ...
        <div class="tab">
            <input type="radio" id="tab-5" name="tab-group-1" <?php
        ...
        <div class="tab">
            <input type="radio" id="tab-6" name="tab-group-1" <?php
